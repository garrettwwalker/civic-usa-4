...
function icon(name, size = 20) {
  ...
  const icons = {
    ...
    picket: `<svg ${s}><rect x="5" y="3" width="14" height="13" rx="1"/><path d="M8 7h8M8 11h5"/><path d="M12 16v6"/></svg>`,
    ...
    dollar: `<svg ${s}><rect x="3" y="5" width="18" height="14" rx="1"/><circle cx="12" cy="12" r="3"/></svg>`,
